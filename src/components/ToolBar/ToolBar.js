...
const playerTokens = []
    ...
    return(
        ...
        <Game
            ...
            foe = {foe[0].name} foeHp = {foe[0].health} foeIcon = {foe[0].url}
            foe1 = {foe[1].name} foe1Hp = {foe[1].health} foe1Icon = {foe[1].url}
            foe2 = {foe[2].name} foe2Hp = {foe[2].health} foe2Icon = {foe[2].url}
